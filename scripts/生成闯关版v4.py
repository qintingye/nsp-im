#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""闯关版 v4 · 新版 xlsx (70 题 ·全有答案)"""
import json
from pathlib import Path
from collections import Counter

JSON_FILE = Path(r'C:/Users/Administrator/AppData/Local/Temp/all_questions_v4.json')
...
print(f'总题数: {len(ALL)}（有答案: {has_ans_cnt}）')
...
题库已更新 · 2026-08-25<br>
共 <b>__TOTAL__ 题</b>（<b>全部有答案</b>）· v4 完整版<br>
题型：单选 53 + 多选 16 + 不定项 1
</div>
